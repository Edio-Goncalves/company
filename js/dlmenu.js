  ...
  (n.DLMenu = function (i, e) {
    ...
    (n.DLMenu.prototype = {
      _init: function (i) {
        ...
        (this.animEndEventName = e[t.prefixed("animation")] + ".dlmenu"),
          (this.transEndEventName = s[t.prefixed("transition")] + ".dlmenu"),
      ...
      _config: function () {
        (this.open = !1),
          ...
          this.$el
            .find("ul.dl-submenu")
            .prepend('<li class="dl-back"><a href="#">&nbsp;</a></li>'),
        ...
        this.$trigger.on("click.dlmenu", function () {
          ...
          this.$menuitems.on("click.dlmenu", function (e) {
            ...
            if (s.length > 0) {
              ...
              return (
                setTimeout(function () {
                  o.addClass(i.options.animationClasses.classin),
